...
git clone https://github.com/phoenix-1708/xRageTC-clang.git clang
...
function zipping() {
    ...
    ./telegram -t 1858827137:AAFZVaKOjAhjVyCXfiGgL-SK6dp7_lILZIE -c -1001521910426 -f $REPACK_DIR/PhoenixKernel_NonOC.zip "Zip Sent through Cirrus CI"
